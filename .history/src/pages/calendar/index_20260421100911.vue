      ...
      <div class="events-section">
        ...
        <div class="events-list">
          <div
            ...
            v-if="event && event.date && new Date(event.date).getMonth() === currentMonth && new Date(event.date).getFullYear() === currentYear"
          >
          ...
          <!-- 无事件提示 -->
          <div v-if="events.value.filter(e => new Date(e.date).getMonth() === currentMonth && new Date(e.date).getFullYear() === currentYear).length === 0" class="no-events">
