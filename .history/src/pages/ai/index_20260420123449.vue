...
import { useDoubao } from '@/composables/useDoubao'

const { selectedZodiac, getZodiacInfo } = useZodiac()
const { chatWithZodiacContext, isLoading: isApiLoading, error: apiError } = useDoubao()
...
const sendMessage = async () => {
  ...
  const info = currentZodiac.value
  const apiKeyConfigured = !!import.meta.env.VITE_DOUBAO_API_KEY
