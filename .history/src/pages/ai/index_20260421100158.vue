...
const scenarios = [
  {
    ...
    icon: '❤️',
    questions: [
      `作为${selectedZodiac.value}，我如何找到理想的伴侣？`,
      `${selectedZodiac.value}在爱情中需要注意什么？`,
      `${selectedZodiac.value}与哪些星座最适合发展恋情？`,
      `如何与${selectedZodiac.value}的恋人保持良好关系？`
    ]
  },
  {
    id: 'career',
    ...
    icon: '💼',
    questions: [
      `${selectedZodiac.value}适合什么类型的工作？`,
      `作为${selectedZodiac.value}，如何在职场中脱颖而出？`,
      `${selectedZodiac.value}的职业发展建议是什么？`,
      `如何与不同星座的同事相处？`
    ]
  },
  {
    ...
    icon: '🌟',
    questions: [
      `今天的${selectedZodiac.value}整体运势如何？`,
      `${selectedZodiac.value}的健康注意事项有哪些？`,
      `如何改善${selectedZodiac.value}的财运？`,
      `${selectedZodiac.value}的幸运数字和颜色是什么？`
    ]
  },
  {
    id: 'personality',
    ...
    icon: '🧠',
    questions: [
      `${selectedZodiac.value}的性格特点是什么？`,
      `如何发挥${selectedZodiac.value}的性格优势？`,
      `如何克服${selectedZodiac.value}的性格弱点？`,
      `${selectedZodiac.value}的思维方式有什么特点？`
    ]
  }
]
...
const toggleScenarios = () => {
  showScenarios.value = !showScenarios.value
}
      ...
      <div class="ai-card">
        ...
        <div class="scenarios-section">
          <div class="scenarios-header" @click="toggleScenarios">
            <span class="scenarios-label">场景问答</span>
            <span class="scenarios-toggle">{{ showScenarios ? '▼' : '▶' }}</span>
          </div>
          <div v-if="showScenarios" class="scenarios-list">
