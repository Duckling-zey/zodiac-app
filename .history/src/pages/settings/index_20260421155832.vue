...
const { selectedZodiac, setSelectedZodiac, zodiacList, getZodiacInfo } = useZodiac()
...
const resetSettings = () => {
  if (confirm('确定要重置所有设置吗？')) {
    ...
    // 保存重置后的星座到本地存储
    localStorage.setItem('selectedZodiac', '白羊座')
            ...
            <div class="setting-item">
              ...
              <div class="zodiac-card" @click="showPicker = true">
                <div class="zodiac-content">
                  <span class="zodiac-symbol">{{ getZodiacInfo(selectedZodiac)?.symbol }}</span>
                  <div class="zodiac-info">
                    <span class="zodiac-name">{{ selectedZodiac }}</span>
                    <span class="zodiac-date">{{ getZodiacInfo(selectedZodiac)?.dateRange }}</span>
                  </div>
                </div>
            ...
            <div class="setting-item">
              ...
              <div class="theme-options">
                ...
                <div
                  ...
                  @click="settings.theme = 'auto'; applyTheme('auto')"
                >
                  <span class="theme-icon">🔄</span>
